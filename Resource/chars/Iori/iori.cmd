...
[State -1, Combo2]
type = Varset
trigger1 = stateno = 210 && animelemtime(4) >= 0 ;&& animelemtime(5) < 0
trigger2 = stateno = 230 && animelemtime(3) >= 0 ;&& animelemtime(4) < 0
trigger3 = stateno = 250 && animelemtime(3) >= 0 ;&& animelemtime(5) < 0
trigger4 = stateno = 400 && animelemtime(3) >= 0 ;&& animelemtime(4) < 0
trigger5 = stateno = 440 && animelemtime(5) >= 0 ;&& animelemtime(6) < 0
trigger6 = stateno = 280 && animelemtime(3) >= 0 ;&& animelemtime(5) < 0
trigger7 = stateno = 703 && animelemtime(5) >= 0 ;&& animelemtime(6) < 0 
trigger8 = stateno = 215 && animelemtime(5) >= 0 ;&& animelemtime(6) < 0 
trigger9 = stateno = 217 && animelemtime(4) >= 0 ;&& animelemtime(5) < 0 
trigger10 = stateno = 237 && animelemtime(9) >= 0 ;&& animelemtime(13) < 0 && movecontact
trigger11 = stateno = 240 && animelemtime(1) >= 0 && animelemtime(5) < 3 ;&& movecontact
ignorehitpause = 1
var(39) = var(39) | 1
